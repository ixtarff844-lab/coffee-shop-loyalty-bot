...
2. `ADMIN_IDS` — список telegram_id продавцов (узнать свой id можно у @userinfobot)
3. `POINTS_PER_RUBLE` — процент кэшбэка (по умолчанию 0.05 = 5%)
4. `CAFE_INFO` — тексты, адрес, часы работы, контакты
5. Положи фото кафе в папку `photos/` и пропиши пути в `CAFE_INFO["photos"]`
